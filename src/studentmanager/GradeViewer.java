...
public class GradeViewer extends javax.swing.JFrame {
     ...
     */
    public GradeViewer(String sem,Hashtable<String,String> semarks) {
        initComponents();
        jTextField1.setText(sem);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
        for(String subject:semarks.keySet())
        {
            model.addRow(new Object[]{subject,"", semarks.get(subject)});
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("View Grades By Semester");
