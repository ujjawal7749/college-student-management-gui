...
public class NewBranch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Number of Semesters");

        jTextField3.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        jButton1.setText("Add Branch to Database");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String semesters = jTextField3.getText();
        
        String[] items = {id,name,semesters};
        
        dbexec.query(dbhelp.makesql("branch", items));
